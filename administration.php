...
<div class="fichier window" id="fichier">
    ...
    if (isset($_SESSION['identifiant'])) {
        ...
        echo '<input type="text" name="identifiant" id="identifiant" value="' . $select->fetch()['identifiant'] . '">';
        echo '</div>';
        echo '<div class="div-form-user-left-top-right">';
        echo '<label for="nom">Nom</label>';
        echo '<input type="text" name="nom" id="nom" value="' . $select->fetch()['nom'] . '">';
        echo '</div>';
        echo '</div>';
        echo '<div class="div-form-user-left-bottom">';
        echo '<label for="prenom">Prénom</label>';
        echo '<input type="text" name="prenom" id="prenom" value="' . $select->fetch()['prenom'] . '">';
        echo '</div>';
        echo '</div>';
        echo '<div class="div-form-user-right">';
        echo '<div class="div-form-user-right-top">';
        echo '<label for="email">Email</label>';
        echo '<input type="text" name="email" id="email" value="' . $select->fetch()['email'] . '">';
        echo '</div>';
        echo '<div class="div-form-user-right-bottom">';
        echo '<label for="password">Mot de passe</label>';
        echo '<input type="password" name="password" id="password" value="' . $select->fetch()['password'] . '">';
        echo '</div>';
        echo '</div>';
        echo '</div>';
